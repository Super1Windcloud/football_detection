...
PITCH_DETECTION_MODEL_PATH = os.path.join(
    PARENT_DIR, "models/football-pitch-detection.pt"
)
BALL_DETECTION_MODEL_PATH = os.path.join(
    PARENT_DIR, "models/football-ball-detection.pt"
)
...
EDGE_ANNOTATOR = sv.EdgeAnnotator(
    color=sv.Color.from_hex("#FF1493"), edges=CONFIG.edges
)
...
def run_pitch_detection(source_video_path: str, device: str) -> Iterator[np.ndarray]:
    ...
    for frame in frame_generator:
        result = pitch_detection_model(source=frame, verbose=False)[0]
